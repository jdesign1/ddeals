 ...
 * markup/classes, translated to this app's actual search (Home's inline
 * search input, not the prototype's full-screen search overlay, which
 * doesn't exist here — see page.tsx's doc comment).
 */
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[51] mx-auto flex max-h-[92dvh] w-full max-w-md flex-col overflow-hidden rounded-t-3xl border-x border-t border-stone-200 bg-white shadow-2xl"
          >
            <div className="flex items-center justify-between border-b border-stone-200 px-6 py-4">
              <div className="flex items-center gap-3">
                <Camera className="h-4 w-4 text-ink-600" aria-hidden="true" />
                <h3 className="font-display text-base font-bold uppercase tracking-wider text-stone-900">
                  Price Tag Scanner
                </h3>
              </div>
              <button
            ...
            <div className="flex-1 space-y-6 overflow-y-auto p-6">
              {!capturedImage && (
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <p className="text-xs font-bold uppercase tracking-wider text-stone-800">Scan Barcode</p>
                  ...
                  <div className="my-4 flex items-center">
                    ...
                    <span className="mx-3 text-[9px] font-black uppercase tracking-widest text-stone-400">Or</span>
                    <div className="grow border-t border-stone-200" />
                  </div>
                  ...
                  >
                    ...
                    <p className="text-xs font-bold uppercase tracking-wider text-stone-800">Upload Photo</p>
                    <p className="text-[10px] font-black uppercase tracking-widest text-stone-400">
              ...
              {capturedImage && (
                <div className="space-y-6">
                  ...
                  <p className="text-center text-xs font-medium leading-relaxed text-stone-500">
              ...
              {capturedImage ? (
                <>
                  <button
                    ...
                    className="flex-1 cursor-pointer rounded-xl border border-stone-200 px-4 py-3 text-xs font-black uppercase tracking-widest transition-colors hover:bg-stone-100"
                  >
                    Retake
                  </button>
                  <button
                    onClick={handleSearchForItem}
                    className="flex-1 cursor-pointer rounded-xl bg-stone-900 px-4 py-3 text-xs font-black uppercase tracking-widest text-white shadow-md hover:bg-ink-600"
                  >
