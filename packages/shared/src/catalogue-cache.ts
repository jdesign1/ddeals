 ...
 * old cached catalogue cannot preserve a stale classifier result. The v4
 * duration-aware evidence rollout invalidates v3 records that may have been
 ...
 */
const CATALOGUE_CACHE_VERSION = 4;
